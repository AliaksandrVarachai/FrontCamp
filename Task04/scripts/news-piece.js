...
let sectionGenerator = window.SectionGenerator();
let newsPiece = new window.NewsPiece(responseFormat, apiKey, sectionGenerator.next().value); //implementation of class
